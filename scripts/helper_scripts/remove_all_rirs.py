...
def parse_args():
    ...
    parser.add_argument("--backup_dir", type=str, default="data/raw/rirs_backup", help="Backup directory for RIR files")
...
def main():
    ...
    rir_silent = df[(df["status"] == "silent") & (df["path"].str.contains("RIRs", case=False, na=False))]
