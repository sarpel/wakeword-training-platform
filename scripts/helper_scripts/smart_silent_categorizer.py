...
def main():
    parser = argparse.ArgumentParser(
        description="Smart silent audio categorizer - keep useful files, move others to be deleted"
    )
    parser.add_argument(
        "--report",
        default="C:/Users/Sarpel/Desktop/project_1/data/raw/silent/silent_report.tsv",
        help="Path to the silent report TSV file",
    )
    parser.add_argument(
        "--run", action="store_true", help="Actually move files (without this flag, shows preview only)"
    )
    parser.add_argument(
        "--to_deleted_dir",
        default="C:/Users/Sarpel/Desktop/project_1/to_be_deleted",
