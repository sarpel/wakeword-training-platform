...
def run_benchmark():
    ...
    trainer_ce = Trainer(
        model_ce, train_loader, val_loader, config_ce, CheckpointManager(results_dir / "ce"), device=device
    )
    ...
    trainer_focal = Trainer(
        model_focal, train_loader, val_loader, config_focal, CheckpointManager(results_dir / "focal"), device=device
    )
    ...
    trainer_qat = Trainer(
        model_qat, train_loader, val_loader, config_qat, CheckpointManager(results_dir / "qat"), device=device
    )
